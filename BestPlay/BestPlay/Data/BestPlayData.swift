...
let PostData: [BestPlay] = [
    ...
    BestPlay(userProfileImage: UIImage(named: "anaprofile"), userName: "아나장인 홍재민", thumNail: UIImage(named: "ana1"), isVideo: true, videoUrl: "https://www.youtube.com/watch?v=PlB8zNEGTnY", text: "갓재민 아나 하이라이트", heart: 999, comment: [
        ...
        Comment(userProfileImage: UIImage(named: "user3"),userName: "헬종혁", text: "쫌 하시네요\n 줄바꿈 테스트\n또줄바꾸기"),
        Comment(userProfileImage: UIImage(named: "user2"),userName: "페페", text: "갓재민@@"),
        Comment(userProfileImage: UIImage(named: "user5"),userName: "신 현우", text: "신")
    ],
             myheart: true, genre: .fps),
    
    BestPlay(userProfileImage: UIImage(named: "ganjiprofile"), userName: "학살 이정민", thumNail: UIImage(named: "genji1"), isVideo: true, videoUrl: "https://www.youtube.com/watch?v=4a65BV5rUuk", text: "겐지 용검 하이라이트", heart: 229, comment: [],myheart: true, genre: .fps),
    
    
    
    BestPlay(userProfileImage: UIImage(named: "winstonprofile"), userName: "동스턴 킴동경", thumNail: UIImage(named: "winston1"), isVideo: true, videoUrl: "https://www.youtube.com/watch?v=er6mV3HKZ-Y", text: "동스턴 ㄱ", heart: 142, comment: [],genre: .fps),
    
    BestPlay(userProfileImage: UIImage(named: "jenyataprofile"), userName: "젠야타 고수 황인영", thumNail: UIImage(named: "jenyata1"), isVideo: true, videoUrl: "https://www.youtube.com/watch?v=E1eJ-GId7XI", text: "젠야타 폼 미쳤다", heart: 673, comment: [], genre: .fps),
    ...
    BestPlay(userProfileImage: UIImage(named: "fifaprofile"), userName: "피파", thumNail: UIImage(named: "fifa1"), isVideo: true, videoUrl: "https://www.youtube.com/watch?v=f5ipBPGv-lY", text: "토트넘 가보자", heart: 753, comment: [], genre: .sport),
